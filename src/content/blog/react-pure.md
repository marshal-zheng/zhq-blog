...
在与 React 打交道的过程中，或多或少听说过一个核心原则：“**React 组件应该是纯粹的 (Components should be pure)**”。这不仅仅是一句口号，更是 React 设计哲学中一条非常重要的规则。如果我们不小心打破了这条规则，写出了“不纯粹”的组件，那么各种令人头疼的问题就可能接踵而至：
