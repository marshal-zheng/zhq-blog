...
import { HeroVideoDialog } from "../components/VideoDialog.tsx";


## 介绍

<div class="profile-video flex items-center gap-4">
  <span class="text-red-600">📛 可以叫我「HQ」</span>
  <div className="relative">
    <HeroVideoDialog
      client:load
      className="dark:hidden block"
      animationStyle="from-center"
      videoSrc="https://marsio.top/videos/zhq_profile.mp4"
